...
const Befejezes = () => {
  return (
    <div>
      ...
      <h2 id="vizualizációs-lehetőségek">Vizualizációs lehetőségek</h2>
      <p>
        A Power BI egyik legnagyobb előnye az adatvizualizációs lehetőségek,
        valamint a reporting flexibilátásában rejlik, emiatt fontosnak tartottuk
      ...
      <p>
        ...
        lehetőségekkel sem tudunk élni ezesetben. (
        <a href="https://docs.microsoft.com/en-us/power-bi/connect-data/desktop-python-visuals">
          https://docs.microsoft.com/en-us/power-bi/connect-data/desktop-python-visuals
        </a>
        ){" "}
        <a href="https://docs.microsoft.com/en-us/power-bi/create-reports/desktop-r-visuals">
          https://docs.microsoft.com/en-us/power-bi/create-reports/desktop-r-visuals
        </a>{" "}
        A fenti okokból kifolyólag a script vizualizációk lehetőségét a
        továbbiakban nem tárgyaljuk. Amennyiben a scriptünket nem kifejezetten a
        vizualizációs lehetőségekbe építjük be, hanem valamelyik előkészítési
      ...
      <p>
        ...
        adattáblákat, amihez mindenképpen szükséges a Desktop használata (
        <a href="https://docs.microsoft.com/en-us/power-bi/transform-model/dataflows/dataflows-configure-consume">
      ...
      <p>
        ...
        alapú webes felületen keresztül elérhető. A Desktopos forecasting
        lehetőség igényel néhány előkészületet az adatbevitel szempontjából,
        azonban összességében ez is jól használható a gyakorlatban. (
        <a href="https://docs.microsoft.com/en-us/power-bi/transform-model/desktop-analytics-pane">
          https://docs.microsoft.com/en-us/power-bi/transform-model/desktop-analytics-pane
        </a>
        ) Elmondható azonban, hogy a lehetőségek száma és testreszabhatóság
        mértéke a különböző script alapú megoldásokkal és könyvtárakkal szemben
        igen korlátozott. (
        <a href="https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration">
          https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration
        </a>
        )
      </p>
      <h2 id="modellezés">Modellezés</h2>
      <p>
        ...
        kénytelenek voltunk leszűkíteni az összegzést néhány kitüntett
        ...
        igyekeztünk megmaradni az a Power BI integrációk kontextusában.
      </p>
      <h3 id="r--python-2">R &amp; Python</h3>
      <p>
        ...
        Datasetbe ágyazni. Ezzel természetesen együtt jár az is, hogy a
        ...
        <a href="https://docs.microsoft.com/en-us/power-bi/connect-data/desktop-r-in-query-editor">
          https://docs.microsoft.com/en-us/power-bi/connect-data/desktop-r-in-query-editor
        </a>
        ) (
        <a href="https://docs.microsoft.com/en-us/power-bi/connect-data/desktop-python-in-query-editor">
          https://docs.microsoft.com/en-us/power-bi/connect-data/desktop-python-in-query-editor
        </a>
        )
      </p>
      <h3 id="automl-2">AutoML</h3>
      <p>
        ...
        modell mentésére és egyszerű kiértékelésére, ami nagyban megkönnyítette
        számunkra a trainelési és tesztelési folyamatokat. (
        <a href="https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration">
          https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration
        </a>
        )
      </p>
      <h2 id="adatelőkészítés">Adatelőkészítés</h2>
      <p>
        ...
        foglaljuk össze. Ahogyan már a 'Developer experience' szekcióban is
        érintettük, néhány esetben adatkonverziós hibák léphetnek fel, pl. dátum
        mezők alkalmazása esetén (pl. idősoros adathalmazokra épülő regressziós
        modelleknél) lokalizációs problémák merülhetnek fel az adatforrástól
        függően. Ezek a problémák önmagukban viszonylagosan könnyen
        orvosolhatóak, azonban összetettebb adatmodellek esetén egyre nagyobb
        kihívást jelenthetnek. Adattisztításra a Power BI ezekben az esetekben
        kiváló beépített lehetőségeket nyújt, azonban annyit meg kell említeni,
        hogy a script megoldásoknál kihasználhatjuk mind a Desktop, mind pedig
        az adott programnyelv lehetőségeit is, míg az AutoML-nél meg kell
        elégednünk azokkal az opciókkal, amik Dataflow-k kialakításához érhetőek
        el a Serviceben. A training adatok átalakítására a Power BI-on belül más
        lehetőség az AutoML részéről nincs. (
        <a href="https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration">
          https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration
        </a>
        )
      </p>
      <h2 id="service---desktop-kompatibilitás">
      ...
      <p>
        ...
        <a href="https://docs.microsoft.com/en-us/power-bi/fundamentals/service-service-vs-desktop">
          https://docs.microsoft.com/en-us/power-bi/fundamentals/service-service-vs-desktop
        </a>
        )
      </p>
      <h3 id="r--python-3">R &amp; Python</h3>
      <p>
        ...
        scriptek kivételével) csak a Desktopon szerkezthetőek a Datasetek
        ...
        Datasetek ütemezett frissítésével lehetővé válik, hogy dinamikus
        predikciókat hozzunk létre. (
        <a href="https://docs.microsoft.com/en-us/power-bi/connect-data/refresh-scheduled-refresh">
          https://docs.microsoft.com/en-us/power-bi/connect-data/refresh-scheduled-refresh
        </a>
        )
      </p>
      <h3 id="automl-3">AutoML</h3>
      <p>
        AutoML-en a munkafolyamat iránya az eddigiekkel szemben fordított, míg a
        Dataflowkat és a modelljeinket kénytelenek vagyunk Serviceben
        létrehozni, addig a Dataflow limitációi miatt a reportoláshoz szükséges,
        hogy a modellezés, illetve a predikció eredményeit kiexportáljuk
        Desktopba. Mivel ezesetben a reportokat és a hozzájuk tartozó
        Dataseteket újfent fel kell töltenünk a Servicebe annak érdekében, hogy
        meg tudjuk osztani őket, ezért ez a megoldás egy kissé időigényesebb és
        az összetettebb folyamat miatt több hibalehetőségre ad okot. (
        <a href="https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration">
          https://docs.microsoft.com/hu-hu/power-bi/transform-model/dataflows/dataflows-machine-learning-integration
        </a>
        )
      ...
      <p>
        ...
        különböző licenszfajták nyújtotta lehetőségeket vetjük össze az ML
      ...
      <h2 id="összegző-táblázat">Összegző táblázat</h2>
      <p>
        A fenti információkat a könnyebb átláthatóság érdekében egy táblázatban
        összegeztük:
      </p>
      <OsszesitoTablazat />
      ...
      <p>
        ...
        alkalmasak. Nagyobb projektek, robosztusabb ML alkalmazások
        ...
        rendszert, aminek a kimeneti adatai egy, a Power BI által támogatott
        adatformátumba kerülnek eltárolásra. Erre példa lehet egy hálózatról
        elérhető Microsoft SQL adatbázis, egy on-premise gatewayról elérhető
        fájlrendszer, egy felhőalapú tárhelyszolgáltatás (pl. OneDrive), vagy
        akár egy publikusan elérhető REST API is. (
        <a href="https://docs.microsoft.com/en-us/power-bi/connect-data/power-bi-data-sources">
          https://docs.microsoft.com/en-us/power-bi/connect-data/power-bi-data-sources
        </a>
        ) Egy másik opció az Azure Machine Learning felhőszolgáltatás használata
        lehet, amihez szükségünk van egy megfelelő Azure előfizetésre is,
        azonban az AutoML-hez képest jóval nagyobb mozgásteret tesz lehetővé. (
        <a href="https://docs.microsoft.com/en-us/power-bi/transform-model/dataflows/dataflows-machine-learning-integration">
          https://docs.microsoft.com/en-us/power-bi/transform-model/dataflows/dataflows-machine-learning-integration
        </a>
        ) Ezeknek a külső megoldások vizsgálata nem képezi szerves részét a
