    ...
    return (
        <div>
            ...
            <div>
                ...
                <p>Ez a platform volt az egyik jelentős adattárolási szerepet betöltő eszközünk, mivel nem csak interaktív report szerkesztési és bővítési lehetőségek álltak rendelkezésünkre, hanem ide kerültek közzé tételre az egyes reportok, datasettek és kerültek létrehozásra a dataflow-jaink. Azure Active Directory tenant-on keresztül kaptunk hozzáférést, amelyet konzulensünk bocsájtott rendelkezésünkre.</p>
                ...
                <h2 id="automl-k-vetelm-nyek">AutoML követelmények</h2>
                <p>Az AutoML-lel való modellezés a Power BI Service egy szolgáltatása, így értelemszerűen csak ott hajtható végre. Ezen szolgáltatás használatához szükséges Prémium licensszel rendelkezni, továbbá internetkapcsolatnak a Service eléréséhez. A munkakörnyezet kialakítása során Premium Workspacet kell létrehozni a Serviceben, ahol csak Adatfolyamon belül érhető el az AutoML. Az előrejelzett adatokból való jelentések készítése érdekében Power BI Desktopra van szükség, mivel a Service nem támogatja.</p>
                <h2 id="r-k-vetelm-nyek">R követelmények</h2>
                ...
                <p>Ezek közül a kódírás megkönnyítésére az 'R Extension for Visual Studio Code' 2.3.6-os verzióját használtuk, mely számos hasznos funkciót magába foglal, többek között szervizalapú kódanalízist, szintaxis kiemelést, package managementet, terminál-kezelést valamint vizuális adatelemzést is. (https://github.com/REditorSupport/vscode-R) Ennek jó alternatívája lehetett volna az RStudio nevű IDE, amely inkluzívan tartalmaz lehetőségeket R scriptek futtatására, buildelésére, valamint programírásra. Az egyszerűség kedvéért mi a Visual Studio Code-ot alkalmaztuk.</p>
                <p>A script interpretálásához és futtatáshoz az R standard, hivatalos 4.1.2-es verzióját használtuk.</p>
                <p>Az R beépített függvénykönyvtára számos out-of-box lehetőséget tartalmaz mind adatelőkészítési és -transzformációs feladatokhoz, mind ML algoritmusok készítéséhez. Binary classificationhöz mi a beépített glm függvényt használtuk, amely generalizált lineáris modellek alkotására alkalmas. Ez a függvény nagymértékben paraméterezhető, rugalmas, valamint beépített jellege miatt kevésbé okoz kitettséget külső dependenciák felé. (https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/glm)</p>
                <p>Forecastingra a 'forecast' nevű R könyvtár 8.15-ös verziója jó megoldásnak bizonyult az egyszerű kezelhetősége miatt. Ennek a könyvtárnak elsősorban a HoltWinters módszer alapú függvényeit és objektumait használtuk ki.</p>
                <h2 id="python-k-vetelm-nyek">Python követelmények</h2>
                ...
                <h4 id="statsmodels">Statsmodels</h4>
                ...
                <ul>
                    ...
                    <li>Refactorálás</li>
                    <li>Variable explorer (Változók állapotának és értékeinek nyomonkövetésére)</li>
