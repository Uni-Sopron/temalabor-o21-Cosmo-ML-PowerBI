...
Az AutoML-ben készített modellekhez nem szükséges semmilyen technikai háttértudás, maga a fejlesztési folyamat jól dokumentált, egyszerű és átlátható. Ez a módszer kódírást nem igényel, minden lépése egy SaaS alapú webes felületen keresztül elérhető. A [Desktopos forecasting lehetőség](https://docs.microsoft.com/en-us/power-bi/transform-model/desktop-analytics-pane) igényel néhány előkészületet az adatbevitel szempontjából, azonban összességében ez is jól használható a gyakorlatban.
Elmondható azonban, hogy a lehetőségek száma és testreszabhatóság mértéke a különböző script alapú megoldásokkal és könyvtárakkal szemben igen [korlátozott](https://docs.microsoft.com/en-us/power-bi/transform-model/dataflows/dataflows-machine-learning-integration).
